...
/**
 * Class html5_video_view
 */
class html5_video_view implements renderable, templatable {
     ...
     */
    public function __construct($source, $crossorigin = '') {
        $this->source = $source;
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $data->crossorgin = $this->crossorigin;
