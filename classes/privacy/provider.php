...
class provider implements
  ...
  public static function export_user_data(approved_contextlist $contextlist) {
    ...
    $sql =
      "SELECT id AS videocommentid, video_id AS videoid FROM {ivs_videocomment} WHERE user_id = :user_id AND video_id {$contextsql}";
    ...
    $sql =
      "SELECT id AS takeid, question_id AS answerid FROM {ivs_matchanswer} WHERE user_id = :user_id AND question_id {$contextsql}";
    $params['user_id'] = $userid;
