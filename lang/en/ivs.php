...
$string['ivs_setting_read_access_lock_help'] = 'Read access when creating new or editing existing video comments cannot be changed and then corresponds to the selected setting.';
